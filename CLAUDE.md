...
Frontend (5173) ──WebSocket + REST──► Backend (3000)
                                          ├── sshClient.js      → conexión SSH persistente a 172.18.164.33
...
- **Acceso al 3CX:** Solo via SSH key-based hacia `172.18.164.33`. No instalar agentes adicionales en el 3CX (node_exporter ya está; no agregar más).
